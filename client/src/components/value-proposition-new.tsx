import { Clock, Award, CheckCircle, Shield, Zap, Users, Star } from "lucide-react";

export default function ValuePropositionNew() {
  const valuePoints = [
    {
      icon: Clock,
      title: "30-Minute Guarantee",
      description: "Extra attention when we finish early - no additional cost",
      highlight: true
    },
    {
      icon: Shield,
      title: "Fully Insured & Bonded",
      description: "Complete protection for your business and peace of mind",
      highlight: false
    },
    {
      icon: Zap,
      title: "Same-Day Response",
      description: "Emergency cleaning services available 24/7",
      highlight: false
    },
    {
      icon: Users,
      title: "200+ Happy Clients",
      description: "Trusted by Winnipeg's leading businesses",
      highlight: false
    }
  ];
  ...
  const benefits = [
    ...
    "Complete washroom hygiene",
    "Seamless staff continuity"
  ];
